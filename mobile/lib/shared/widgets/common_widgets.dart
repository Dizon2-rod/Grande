...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isFlashSale = product['is_flash_sale'] == 1 && product['flash_sale_status'] == 'approved';
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                // Image - Fixed aspect ratio for consistent card heights
                ClipRRect(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFFFF2BAC), Color(0xFFFF6B6B)],
                        ),
                ...
                // Content area - Use flexible layout to prevent overflow
                Padding(
